...
In this project, I learn more on object-oriented programming in Python. I learned about class methods, static methods, class vs instance attributes, and how to use the special  methods; `__str__` and `__repr__` 
